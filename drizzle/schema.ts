import { pgTable, pgSchema,customType, pgEnum, serial, varchar, timestamp, foreignKey, integer, text, unique, date, index, bigserial, boolean, bigint, char, json, jsonb, uniqueIndex, doublePrecision } from "drizzle-orm/pg-core"
...
export const zuvyBootcampType = main.table("zuvy_bootcamp_type", {
	id: serial("id").primaryKey().notNull(),
	bootcampId: integer("bootcamp_id").references(() => zuvyBootcamps.id, { onDelete: "cascade" } ),
...
export const zuvyClassesGoogleMeetLink = main.table("zuvy_classes_google_meet_link", {
	id: serial("id").primaryKey().notNull(),
