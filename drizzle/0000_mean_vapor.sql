...
DO $$ BEGIN
<<<<<<<< HEAD:drizzle/0000_mean_vapor.sql
 CREATE TYPE "main"."action" AS ENUM('submit', 'run');
========
 CREATE TYPE "action" AS ENUM('submit', 'run');
>>>>>>>> 142bc9f78ca270935e5ed39c3a496b33e66239f8:drizzle/0000_freezing_squadron_sinister.sql
EXCEPTION
...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_50526_google_user_id" ON "main"."users" USING btree ("google_user_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_80292_partners_slug_unique" ON "main"."partners" USING btree ("slug");
*/