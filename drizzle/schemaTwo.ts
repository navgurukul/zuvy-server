...
export const actionInMain = main.enum("action", ['submit', 'run'])
export const courseEnrolmentsCourseStatusInMain = main.enum("course_enrolments_course_status", ['enroll', 'unenroll', 'completed'])
export const coursesTypeInMain = main.enum("courses_type", ['html', 'js', 'python'])
export const difficultyInMain = main.enum("difficulty", ['Easy', 'Medium', 'Hard'])
export const exercisesReviewTypeInMain = main.enum("exercises_review_type", ['manual', 'peer', 'facilitator', 'automatic'])
export const exercisesSubmissionTypeInMain = main.enum("exercises_submission_type", ['number', 'text', 'text_large', 'attachments', 'url'])
export const submissionsStateInMain = main.enum("submissions_state", ['completed', 'pending', 'rejected'])
export const userRolesCenterInMain = main.enum("user_roles_center", ['dharamshala', 'banagalore', 'all'])
export const userRolesRolesInMain = main.enum("user_roles_roles", ['admin', 'alumni', 'student', 'facilitator'])
export const usersCenterInMain = main.enum("users_center", ['dharamshala', 'bangalore'])
...
export const userSessionInMain = main.table("user_session", {
	id: varchar("id", { length: 255 }).primaryKey().notNull(),
});

export const merakiStudentsInMain = main.table("meraki_students", {
...
export const newStudentsTempInMain = main.table("new_students_temp", {
	id: serial("id").primaryKey().notNull(),
...
export const chanakyaUserEmailInMain = main.table("chanakya_user_email", {
	id: serial("id").primaryKey().notNull(),
...
export const cUsersInMain = main.table("c_users", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		...
		cUsersPartnerIdPartnersIdFk: foreignKey({
			...
			foreignColumns: [partnersInMain.id],
			name: "c_users_partner_id_partners_id_fk"
		}),
	}
});

export const viewPageInMain = main.table("view_page", {
	id: serial("id").primaryKey().notNull(),
...
export const coursesInMain = main.table("courses", {
...
export const schoolInMain = main.table("school", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }),
});

export const dailyMetricsInMain = main.table("daily_metrics", {
	id: serial("id").primaryKey().notNull(),
...
export const studentsSchoolInMain = main.table("students_school", {
	id: serial("id").primaryKey().notNull(),
...
export const donorInMain = main.table("donor", {
	id: serial("id").primaryKey().notNull(),
	donor: varchar("donor", { length: 225 }),
});

export const zuvyAssessmentSubmissionInMain = main.table("zuvy_assessment_submission", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
	marks: integer("marks"),
...
export const kDetailsInMain = main.table("k_details", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
...
export const knexMigrationsInMain = main.table("knex_migrations", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
	name: varchar("name", { length: 255 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const knexMigrationsLockInMain = main.table("knex_migrations_lock", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	isLocked: bigint("is_locked", { mode: "number" }),
});

export const schoolStageInMain = main.table("school_stage", {
	id: serial("id").primaryKey().notNull(),
	schoolId: integer("school_id"),
...
export const migrationsInMain = main.table("migrations", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
	runOn: timestamp("run_on", { withTimezone: true, mode: 'string' }).notNull(),
});

export const partnerAssessmentsInMain = main.table("partner_assessments", {
	id: serial("id").primaryKey().notNull(),
...
export const campusSchoolInMain = main.table("campus_school", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		campusSchoolCampusIdCampusIdFk: foreignKey({
			...
			foreignColumns: [campusInMain.id],
...
export const studentsStagesInMain = main.table("students_stages", {
	id: serial("id").primaryKey().notNull(),
	studentId: integer("student_id"),
...
export const zuvyAssignmentSubmissionInMain = main.table("zuvy_assignment_submission", {
	id: serial("id").primaryKey().notNull(),
...
export const zuvyBootcampTrackingInMain = main.table("zuvy_bootcamp_tracking", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
...
export const youtubeBroadcastInMain = main.table("youtube_broadcast", {
	id: serial("id").primaryKey().notNull(),
...
export const productionVersionsInMain = main.table("production_versions", {
	id: serial("id").primaryKey().notNull(),
...
export const questionAttemptsInMain = main.table("question_attempts", {
	id: serial("id").primaryKey().notNull(),
...
export const scratchInMain = main.table("scratch", {
	id: serial("id").primaryKey().notNull(),
...
export const engArticlesInMain = main.table("eng_articles", {
	id: serial("id").primaryKey().notNull(),
...
export const engLevelwiseInMain = main.table("eng_levelwise", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		engLevelwiseArticleIdEngArticlesIdFk: foreignKey({
			...
			foreignColumns: [engArticlesInMain.id],
			name: "eng_levelwise_article_id_eng_articles_id_fk"
		}),
	}
});

export const engHistoryInMain = main.table("eng_history", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
...
export const zuvyCourseModulesInMain = main.table("zuvy_course_modules", {
	id: serial("id").primaryKey().notNull(),
...
export const userRolesInMain = main.table("user_roles", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	userId: bigint("user_id", { mode: "number" }),
	roles: userRolesRolesInMain("roles").default('student'),
	center: userRolesCenterInMain("center"),
},
(table) => {
	return {
...
export const exercisesHistoryInMain = main.table("exercises_history", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		...
		exercisesHistoryTeamIdC4CaTeamsIdFk: foreignKey({
			...
			foreignColumns: [c4CaTeamsInMain.id],
			name: "exercises_history_team_id_c4ca_teams_id_fk"
		}),
	}
});

export const usersInMain = main.table("users", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
	...
	center: usersCenterInMain("center"),
...
(table) => {
	return {
		...
		usersC4CaFacilitatorIdFacilitatorsIdFk: foreignKey({
			...
			foreignColumns: [facilitatorsInMain.id],
			name: "users_c4ca_facilitator_id_facilitators_id_fk"
		}).onDelete("set null"),
	}
});

export const zuvyCourseProjectsInMain = main.table("zuvy_course_projects", {
	id: serial("id").primaryKey().notNull(),
	title: varchar("title"),
...
export const usersPopularSearchInMain = main.table("users_popular_search", {
	id: serial("id").primaryKey().notNull(),
	courseName: varchar("course_name", { length: 255 }),
...
export const usersSearchInMain = main.table("users_search", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	name: varchar("name", { length: 255 }),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }),
...
export const vbSentencesInMain = main.table("vb_sentences", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
...
export const vbWordsInMain = main.table("vb_words", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
...
export const contactsInMain = main.table("contacts", {
	id: serial("id").primaryKey().notNull(),
	studentId: integer("student_id"),
...
export const incomingCallsInMain = main.table("incoming_calls", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		...
		incomingCallsContactIdContactsIdFk: foreignKey({
			...
			foreignColumns: [contactsInMain.id],
			name: "incoming_calls_contact_id_contacts_id_fk"
		}),
	}
});

export const courseEnrolmentsInMain = main.table("course_enrolments", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
(table) => {
	return {
		...
		courseEnrolmentsCourseIdCoursesIdFk: foreignKey({
			...
			foreignColumns: [coursesInMain.id],
...
export const courseRelationInMain = main.table("course_relation", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	courseId: bigint("course_id", { mode: "number" }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const questionSetsInMain = main.table("question_sets", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		...
		questionSetsVersionIdTestVersionsIdFk: foreignKey({
			...
			foreignColumns: [testVersionsInMain.id],
			name: "question_sets_version_id_test_versions_id_fk"
		}),
	}
});

export const enrolmentKeysInMain = main.table("enrolment_keys", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		...
		enrolmentKeysQuestionSetIdQuestionSetsIdFk: foreignKey({
			...
			foreignColumns: [questionSetsInMain.id],
			name: "enrolment_keys_question_set_id_question_sets_id_fk"
		}),
	}
});

export const exercisesInMain = main.table("exercises", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	reviewType: exercisesReviewTypeInMain("review_type").default('manual'),
	content: text("content"),
	submissionType: exercisesSubmissionTypeInMain("submission_type"),
...
export const coursesV2InMain = main.table("courses_v2", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
...
export const assessmentInMain = main.table("assessment", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
	content: text("content"),
...
export const exercisesV2InMain = main.table("exercises_v2", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
...
export const studentsInMain = main.table("students", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 300 }),
	gender: integer("gender"),
	dob: timestamp("dob", { withTimezone: true, mode: 'string' }),
...
(table) => {
	return {
		...
		studentsCurrentOwnerIdInterviewOwnersIdFk: foreignKey({
			...
			foreignColumns: [interviewOwnersInMain.id],
		...
		studentsSchoolStageIdSchoolStageIdFk: foreignKey({
			...
			foreignColumns: [schoolStageInMain.id],
			name: "students_school_stage_id_school_stage_id_fk"
		}),
	}
});

export const stageTransitionsInMain = main.table("stage_transitions", {
	id: serial("id").primaryKey().notNull(),
	studentId: integer("student_id"),
	fromStage: varchar("from_stage", { length: 255 }),
	toStage: varchar("to_stage", { length: 255 }),
...
export const studentCampusInMain = main.table("student_campus", {
	id: serial("id").primaryKey().notNull(),
	studentId: integer("student_id"),
	campusId: integer("campus_id"),
},
...
export const chanakyaUserRolesInMain = main.table("chanakya_user_roles", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		chanakyaUserRolesRolesChanakyaRolesIdFk: foreignKey({
			columns: [table.roles],
			foreignColumns: [chanakyaRolesInMain.id],
		...
		chanakyaUserRolesPrivilegeChanakyaPrivilegeIdFk: foreignKey({
			...
			foreignColumns: [chanakyaPrivilegeInMain.id],
			name: "chanakya_user_roles_privilege_chanakya_privilege_id_fk"
		}),
	}
});

export const chanakyaAccessInMain = main.table("chanakya_access", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		chanakyaAccessUserRoleIdChanakyaUserRolesIdFk: foreignKey({
			...
			foreignColumns: [chanakyaUserRolesInMain.id],
...
export const chanakyaPartnerGroupInMain = main.table("chanakya_partner_group", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }),
});

export const chanakyaPartnerRelationshipInMain = main.table("chanakya_partner_relationship", {
	id: serial("id").primaryKey().notNull(),
	partnerId: integer("partner_id").notNull(),
...
(table) => {
	return {
		chanakyaPartnerRelationshipPartnerGroupIdChanakyaPartner: foreignKey({
			...
			foreignColumns: [chanakyaPartnerGroupInMain.id],
...
export const chanakyaPrivilegeInMain = main.table("chanakya_privilege", {
	id: serial("id").primaryKey().notNull(),
...
export const chanakyaRolesInMain = main.table("chanakya_roles", {
	id: serial("id").primaryKey().notNull(),
...
export const classesInMain = main.table("classes", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		classRegistrationsClassIdClassesIdFk: foreignKey({
			...
			foreignColumns: [classesInMain.id],
...
export const categoryInMain = main.table("category", {
	id: serial("id").primaryKey().notNull(),
	categoryName: varchar("category_name", { length: 100 }).notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).notNull(),
});

export const classesMailInMain = main.table("classes_mail", {
	id: serial("id").primaryKey().notNull(),
	classId: integer("class_id"),
...
export const recurringClassesInMain = main.table("recurring_classes", {
	id: serial("id").primaryKey().notNull(),
...
export const partnerSpaceInMain = main.table("partner_space", {
	id: serial("id").primaryKey().notNull(),
	partnerId: integer("partner_id"),
...
export const pathwaysV2InMain = main.table("pathways_v2", {
	id: serial("id").primaryKey().notNull(),
...
export const volunteerInMain = main.table("volunteer", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
...
export const courseCategoriesInMain = main.table("course_categories", {
	id: serial("id").primaryKey().notNull(),
	courseId: integer("course_id").notNull(),
	categoryId: integer("category_id").notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).notNull(),
...
export const courseCompletionInMain = main.table("course_completion", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
	courseId: integer("course_id").notNull(),
},
...
export const courseCompletionV2InMain = main.table("course_completion_v2", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
	courseId: integer("course_id").notNull(),
...
export const courseEditorStatusInMain = main.table("course_editor_status", {
	id: serial("id").primaryKey().notNull(),
	courseId: integer("course_id"),
...
export const courseProductionVersionsInMain = main.table("course_production_versions", {
	id: serial("id").primaryKey().notNull(),
	courseId: integer("course_id"),
	lang: char("lang", { length: 2 }).default('en').notNull(),
	version: varchar("version", { length: 255 }),
...
export const dashboardFlagsInMain = main.table("dashboard_flags", {
	id: serial("id").primaryKey().notNull(),
...
export const studentDonorInMain = main.table("student_donor", {
	id: serial("id").primaryKey().notNull(),
	studentId: integer("student_id"),
...
export const emailReportInMain = main.table("email_report", {
	id: serial("id").primaryKey().notNull(),
	partnerId: integer("partner_id").notNull(),
...
export const exerciseCompletionInMain = main.table("exercise_completion", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
...
(table) => {
	return {
		...
		exerciseCompletionExerciseIdExercisesIdFk: foreignKey({
			columns: [table.exerciseId],
			foreignColumns: [exercisesInMain.id],
...
export const feedbacksInMain = main.table("feedbacks", {
	id: serial("id").primaryKey().notNull(),
	studentId: integer("student_id"),
	userId: integer("user_id"),
...
(table) => {
	return {
		...
		feedbacksUserIdCUsersIdFk: foreignKey({
			columns: [table.userId],
			foreignColumns: [cUsersInMain.id],
			name: "feedbacks_user_id_c_users_id_fk"
		}),
	}
});

export const interviewOwnersInMain = main.table("interview_owners", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
...
export const interviewSlotInMain = main.table("interview_slot", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		...
		interviewSlotTransitionIdStageTransitionsIdFk: foreignKey({
			...
			foreignColumns: [stageTransitionsInMain.id],
			name: "interview_slot_transition_id_stage_transitions_id_fk"
		}),
	}
});

export const partnerSpecificBatchesV2InMain = main.table("partner_specific_batches_v2", {
	id: serial("id").primaryKey().notNull(),
	classId: integer("class_id"),
	recurringId: integer("recurring_id"),
	spaceId: integer("space_id"),
...
export const mentorTreeInMain = main.table("mentor_tree", {
	id: serial("id").primaryKey().notNull(),
...
export const mergedClassesInMain = main.table("merged_classes", {
	id: serial("id").primaryKey().notNull(),
	classId: integer("class_id"),
...
export const partnerGroupInMain = main.table("partner_group", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
...
export const partnerGroupRelationshipInMain = main.table("partner_group_relationship", {
	id: serial("id").primaryKey().notNull(),
	partnerGroupId: integer("partner_group_id").notNull(),
...
(table) => {
	return {
		partnerGroupRelationshipPartnerGroupIdPartnerGroupIdFk: foreignKey({
			columns: [table.partnerGroupId],
			foreignColumns: [partnerGroupInMain.id],
			name: "partner_group_relationship_partner_group_id_partner_group_id_fk"
		}),
	}
});

export const partnerGroupUserInMain = main.table("partner_group_user", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	partnerGroupId: integer("partner_group_id").notNull(),
	email: varchar("email", { length: 255 }),
...
export const zuvyFormTrackingInMain = main.table("zuvy_form_tracking", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
...
export const partnerRelationshipInMain = main.table("partner_relationship", {
	id: serial("id").primaryKey().notNull(),
	partnerId: integer("partner_id").notNull(),
	partnerGroupId: integer("partner_group_id").notNull(),
},
...
export const spaceGroupInMain = main.table("space_group", {
	id: serial("id").primaryKey().notNull(),
...
export const partnerUserInMain = main.table("partner_user", {
	id: serial("id").primaryKey().notNull(),
	partnerId: integer("partner_id"),
...
export const pathwayCompletionInMain = main.table("pathway_completion", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
	pathwayId: integer("pathway_id").notNull(),
},
...
export const partnerSpecificBatchesInMain = main.table("partner_specific_batches", {
	id: serial("id").primaryKey().notNull(),
	classId: integer("class_id"),
	recurringId: integer("recurring_id"),
	partnerId: integer("partner_id"),
...
(table) => {
	return {
		...
		partnerSpecificBatchesPathwayIdPathwaysV2IdFk: foreignKey({
			...
			foreignColumns: [pathwaysV2InMain.id],
...
export const pathwayCoursesInMain = main.table("pathway_courses", {
	id: serial("id").primaryKey().notNull(),
	courseId: integer("course_id").notNull(),
	pathwayId: integer("pathway_id").notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).notNull(),
...
export const pathwayCoursesV2InMain = main.table("pathway_courses_v2", {
	id: serial("id").primaryKey().notNull(),
	courseId: integer("course_id").notNull(),
	pathwayId: integer("pathway_id").notNull(),
},
...
export const pathwayMilestonesInMain = main.table("pathway_milestones", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 45 }).notNull(),
	description: varchar("description", { length: 5000 }).notNull(),
	pathwayId: integer("pathway_id").notNull(),
...
export const pathwayPartnerGroupInMain = main.table("pathway_partner_group", {
	id: serial("id").primaryKey().notNull(),
	partnerId: integer("partner_id"),
	pathwayId: integer("pathway_id"),
},
...
export const progressParametersInMain = main.table("progress_parameters", {
	id: serial("id").primaryKey().notNull(),
...
export const pathwayTrackingFormStructureInMain = main.table("pathway_tracking_form_structure", {
	id: serial("id").primaryKey().notNull(),
	pathwayId: integer("pathway_id").notNull(),
...
(table) => {
	return {
		pathwayTrackingFormStructureParameterIdProgressParameter: foreignKey({
			...
			foreignColumns: [progressParametersInMain.id],
		...
		pathwayTrackingFormStructureQuestionIdProgressQuestions: foreignKey({
			...
			foreignColumns: [progressQuestionsInMain.id],
			name: "pathway_tracking_form_structure_question_id_progress_questions_"
		}),
	}
});

export const progressQuestionsInMain = main.table("progress_questions", {
	id: serial("id").primaryKey().notNull(),
	type: varchar("type", { length: 10 }).notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }),
	name: varchar("name", { length: 20 }).notNull(),
...
export const pathwayTrackingRequestDetailsInMain = main.table("pathway_tracking_request_details", {
	id: serial("id").primaryKey().notNull(),
	pathwayId: integer("pathway_id").notNull(),
	mentorId: integer("mentor_id").notNull(),
	menteeId: integer("mentee_id").notNull(),
...
(table) => {
	return {
		pathwayTrackingRequestDetailsRequestIdPathwayTrackingRe: foreignKey({
			...
			foreignColumns: [pathwayTrackingRequestInMain.id],
...
export const pathwayTrackingRequestInMain = main.table("pathway_tracking_request", {
	id: serial("id").primaryKey().notNull(),
	pathwayId: integer("pathway_id").notNull(),
	mentorId: integer("mentor_id").notNull(),
	menteeId: integer("mentee_id").notNull(),
...
export const pathwayTrackingRequestParameterDetailsInMain = main.table("pathway_tracking_request_parameter_details", {
	id: serial("id").primaryKey().notNull(),
...
export const pathwayTrackingRequestQuestionDetailsInMain = main.table("pathway_tracking_request_question_details", {
	id: serial("id").primaryKey().notNull(),
	questionId: integer("question_id").notNull(),
...
export const pathwaysOngoingTopicInMain = main.table("pathways_ongoing_topic", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
	pathwayId: integer("pathway_id").notNull(),
	courseId: integer("course_id").notNull(),
...
(table) => {
	return {
		...
		pathwaysOngoingTopicAssessmentIdAssessmentIdFk: foreignKey({
			...
			foreignColumns: [assessmentInMain.id],
			name: "pathways_ongoing_topic_assessment_id_assessment_id_fk"
		}),
	}
});

export const campusInMain = main.table("campus", {
	id: serial("id").primaryKey().notNull(),
	campus: varchar("campus", { length: 225 }),
	address: varchar("address", { length: 255 }),
});

export const registrationFormDataInMain = main.table("registration_form_data", {
	id: serial("id").primaryKey().notNull(),
	partnerId: integer("partner_id").notNull(),
...
export const registrationFormStructureInMain = main.table("registration_form_structure", {
	id: serial("id").primaryKey().notNull(),
	partnerId: integer("partner_id").notNull(),
...
export const sansaarUserRolesInMain = main.table("sansaar_user_roles", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
...
export const slotBookedInMain = main.table("slot_booked", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		slotBookedInterviewSlotIdInterviewSlotIdFk: foreignKey({
			...
			foreignColumns: [interviewSlotInMain.id],
...
export const studentDocumentsInMain = main.table("student_documents", {
	id: serial("id").primaryKey().notNull(),
	studentId: integer("student_id").notNull(),
...
export const studentJobDetailsInMain = main.table("student_job_details", {
	id: serial("id").primaryKey().notNull(),
	studentId: integer("student_id").notNull(),
...
export const studentPathwaysInMain = main.table("student_pathways", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
	pathwayId: integer("pathway_id").notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }),
...
export const teacherCapacityBuildingInMain = main.table("teacher_capacity_building", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
...
export const userTokensInMain = main.table("user_tokens", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id").notNull(),
...
(table) => {
	return {
		...
		userTokensUserEmailUsersEmailFk: foreignKey({
			...
			foreignColumns: [usersInMain.email],
...
export const mentorsInMain = main.table("mentors", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const merakiCertificateInMain = main.table("meraki_certificate", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
...
export const questionsInMain = main.table("questions", {
	id: serial("id").primaryKey().notNull(),
...
export const questionOptionsInMain = main.table("question_options", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		...
		questionOptionsQuestionIdQuestionsIdFk: foreignKey({
			columns: [table.questionId],
			foreignColumns: [questionsInMain.id],
			name: "question_options_question_id_questions_id_fk"
		}),
	}
});

export const questionBucketsInMain = main.table("question_buckets", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 100 }).notNull(),
...
export const questionBucketChoicesInMain = main.table("question_bucket_choices", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		...
		questionBucketChoicesBucketIdQuestionBucketsIdFk: foreignKey({
			...
			foreignColumns: [questionBucketsInMain.id],
			name: "question_bucket_choices_bucket_id_question_buckets_id_fk"
		}),
	}
});

export const testVersionsInMain = main.table("test_versions", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 45 }).notNull(),
...
export const recordVersionsOfPostDeleteExercisedetailsInMain = main.table("record_versions_of_post_delete_exercisedetails", {
	id: serial("id").primaryKey().notNull(),
	courseId: integer("course_id"),
	exerciseId: integer("exercise_id"),
	version: varchar("version", { length: 255 }),
...
export const ongoingTopicsInMain = main.table("ongoing_topics", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	teamId: integer("team_id"),
	pathwayId: integer("pathway_id").notNull(),
...
(table) => {
	return {
		ongoingTopicsProjectSolutionIdC4CaTeamProjectsubmitSolu: foreignKey({
			...
			foreignColumns: [c4CaTeamProjectsubmitSolutionInMain.id],
		...
		ongoingTopicsProjectTopicIdC4CaTeamProjecttopicIdFk: foreignKey({
			...
			foreignColumns: [c4CaTeamProjecttopicInMain.id],
			name: "ongoing_topics_project_topic_id_c4ca_team_projecttopic_id_fk"
		}).onUpdate("cascade").onDelete("cascade"),
	}
});

export const classesToCoursesInMain = main.table("classes_to_courses", {
	id: serial("id").primaryKey().notNull(),
	classId: integer("class_id"),
...
export const zuvyLanguagesInMain = main.table("zuvy_languages", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
...
export const courseCompletionV3InMain = main.table("course_completion_v3", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	courseId: integer("course_id").notNull(),
	completeAt: timestamp("complete_at", { withTimezone: true, mode: 'string' }),
...
export const pathwayCompletionV2InMain = main.table("pathway_completion_v2", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	completeAt: timestamp("complete_at", { withTimezone: true, mode: 'string' }),
	teamId: integer("team_id"),
...
export const c4CaStudentsInMain = main.table("c4ca_students", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
...
(table) => {
	return {
		c4CaStudentsTeacherIdC4CaTeachersIdFk: foreignKey({
			...
			foreignColumns: [c4CaTeachersInMain.id],
			name: "c4ca_students_teacher_id_c4ca_teachers_id_fk"
		}),
	}
});

export const assessmentsHistoryInMain = main.table("assessments_history", {
	id: serial("id").primaryKey().notNull(),
	slugId: integer("slug_id").notNull(),
...
export const exerciseCompletionV2InMain = main.table("exercise_completion_v2", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	completeAt: timestamp("complete_at", { withTimezone: true, mode: 'string' }),
	exerciseId: integer("exercise_id"),
...
export const c4CaStudentsProjectDetailInMain = main.table("c4ca_students_projectDetail", {
	id: serial("id").primaryKey().notNull(),
...
export const moduleCompletionV2InMain = main.table("module_completion_v2", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	moduleId: integer("module_id").notNull(),
	completeAt: timestamp("complete_at", { withTimezone: true, mode: 'string' }),
...
export const zuvyModuleAssessmentInMain = main.table("zuvy_module_assessment", {
	id: serial("id").primaryKey().notNull(),
	title: varchar("title"),
	description: text("description"),
...
export const c4CaPartnersInMain = main.table("c4ca_partners", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
...
export const assessmentResultInMain = main.table("assessment_result", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
...
export const learningTrackStatusInMain = main.table("learning_track_status", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	pathwayId: integer("pathway_id"),
	courseId: integer("course_id"),
...
export const c4CaTeachersInMain = main.table("c4ca_teachers", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
	school: varchar("school", { length: 255 }),
	district: varchar("district", { length: 255 }),
...
export const assessmentOutcomeInMain = main.table("assessment_outcome", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	assessmentId: integer("assessment_id").notNull(),
	status: varchar("status", { length: 255 }).notNull(),
...
export const facilitatorsInMain = main.table("facilitators", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name", { length: 255 }).notNull(),
	pointOfContact: varchar("point_of_contact", { length: 255 }),
	email: varchar("email", { length: 255 }).notNull(),
...
export const c4CaTeamProjectsubmitSolutionInMain = main.table("c4ca_team_projectsubmit_solution", {
	id: serial("id").primaryKey().notNull(),
...
export const c4CaTeamProjecttopicInMain = main.table("c4ca_team_projecttopic", {
	id: serial("id").primaryKey().notNull(),
	projectTitle: varchar("project_title", { length: 255 }),
	projectSummary: varchar("project_summary", { length: 255 }),
...
export const c4CaTeamsInMain = main.table("c4ca_teams", {
	id: serial("id").primaryKey().notNull(),
	teamName: varchar("team_name", { length: 255 }).notNull(),
...
export const pathwaysOngoingTopicOutcomeInMain = main.table("pathways_ongoing_topic_outcome", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	pathwayId: integer("pathway_id"),
	courseId: integer("course_id"),
...
export const learningTrackStatusOutcomeInMain = main.table("learning_track_status_outcome", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	pathwayId: integer("pathway_id"),
	courseId: integer("course_id"),
...
export const zuvyModuleChapterInMain = main.table("zuvy_module_chapter", {
	id: serial("id").primaryKey().notNull(),
	title: varchar("title"),
	description: text("description"),
...
export const zuvyModuleFormInMain = main.table("zuvy_module_form", {
	id: serial("id").primaryKey().notNull(),
	chapterId: integer("chapter_id").notNull(),
...
export const zuvyBatchEnrollmentsInMain = main.table("zuvy_batch_enrollments", {
	id: serial("id").primaryKey().notNull(),
...
export const c4CaRolesInMain = main.table("c4ca_roles", {
	id: serial("id").primaryKey().notNull(),
...
export const zuvyModuleQuizInMain = main.table("zuvy_module_quiz", {
	id: serial("id").primaryKey().notNull(),
	question: text("question"),
	options: jsonb("options"),
	correctOption: integer("correct_option"),
	marks: integer("marks"),
	difficulty: difficultyInMain("difficulty"),
	tagId: integer("tag_id"),
	usage: integer("usage").default(0),
});

export const zuvyModuleTopicsInMain = main.table("zuvy_module_topics", {
	id: serial("id").primaryKey().notNull(),
	name: varchar("name"),
});

export const zuvyBootcampsInMain = main.table("zuvy_bootcamps", {
	id: serial("id").primaryKey().notNull(),
...
export const zuvyBatchesInMain = main.table("zuvy_batches", {
	id: serial("id").primaryKey().notNull(),
	name: text("name").notNull(),
	bootcampId: integer("bootcamp_id"),
...
(table) => {
	return {
		zuvyBatchesBootcampIdZuvyBootcampsIdFk: foreignKey({
			...
			foreignColumns: [zuvyBootcampsInMain.id],
...
export const zuvyBootcampTypeInMain = main.table("zuvy_bootcamp_type", {
	id: serial("id").primaryKey().notNull(),
	bootcampId: integer("bootcamp_id"),
	type: text("type").notNull(),
},
...
export const zuvyModuleTrackingInMain = main.table("zuvy_module_tracking", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	moduleId: integer("module_id").notNull(),
	progress: integer("progress").default(0),
...
export const talkMitraInMain = main.table("talk_mitra", {
	id: serial("id").primaryKey().notNull(),
...
export const zuvyOpenEndedQuestionSubmissionInMain = main.table("zuvy_open_ended_question_submission", {
	id: serial("id").primaryKey().notNull(),
	answer: text("answer"),
	marks: integer("marks"),
...
export const zuvyOutsourseAssessmentsInMain = main.table("zuvy_outsourse_assessments", {
	id: serial("id").primaryKey().notNull(),
	assessmentId: integer("assessment_id").notNull(),
	bootcampId: integer("bootcamp_id"),
	moduleId: integer("module_id"),
...
export const zuvyOutsourseCodingQuestionsInMain = main.table("zuvy_outsourse_coding_questions", {
	id: serial("id").primaryKey().notNull(),
...
export const zuvyOutsourseOpenEndedQuestionsInMain = main.table("zuvy_outsourse_openEnded_questions", {
	id: serial("id").primaryKey().notNull(),
...
export const zuvyOutsourseQuizzesInMain = main.table("zuvy_outsourse_quizzes", {
...
export const zuvyCodingQuestionsInMain = main.table("zuvy_coding_questions", {
	id: serial("id").primaryKey().notNull(),
	title: varchar("title", { length: 255 }).notNull(),
...
export const partnersInMain = main.table("partners", {
	id: serial("id").primaryKey().notNull(),
...
export const zuvyTagsInMain = main.table("zuvy_tags", {
	id: serial("id").primaryKey().notNull(),
	tagName: varchar("tag_name"),
});

export const subStageInMain = main.table("sub_stage", {
	id: serial("id").primaryKey().notNull(),
	schoolId: integer("school_id"),
...
export const zuvyCodingSubmissionInMain = main.table("zuvy_coding_submission", {
	id: bigserial("id", { mode: "bigint" }).primaryKey().notNull(),
	userId: integer("user_id").notNull(),
...
export const zuvyStudentAttendanceInMain = main.table("zuvy_student_attendance", {
	id: serial("id").primaryKey().notNull(),
...
export const zuvySessionsInMain = main.table("zuvy_sessions", {
	id: serial("id").primaryKey().notNull(),
...
export const zuvyChapterTrackingInMain = main.table("zuvy_chapter_tracking", {
	id: serial("id").primaryKey().notNull(),
	userId: bigserial("user_id", { mode: "bigint" }).notNull(),
	chapterId: integer("chapter_id").notNull(),
	moduleId: integer("module_id").notNull(),
...
export const zuvyPracticeCodeInMain = main.table("zuvy_practice_code", {
	id: serial("id").primaryKey().notNull(),
	userId: bigserial("user_id", { mode: "bigint" }).notNull(),
	status: varchar("status", { length: 255 }).notNull(),
	action: actionInMain("action").notNull(),
	questionId: integer("question_id"),
...
export const zuvyProjectTrackingInMain = main.table("zuvy_project_tracking", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	projectId: integer("project_id"),
	moduleId: integer("module_id"),
...
export const zuvyQuizTrackingInMain = main.table("zuvy_quiz_tracking", {
	id: serial("id").primaryKey().notNull(),
	userId: integer("user_id"),
	moduleId: integer("module_id"),
...
export const zuvyTestCasesInMain = main.table("zuvy_test_cases", {
	id: serial("id").primaryKey().notNull(),
	questionId: integer("question_id"),
...
export const zuvyTestCasesSubmissionInMain = main.table("zuvy_test_cases_submission", {
	id: serial("id").primaryKey().notNull(),
...
export const scratchSampleInMain = main.table("scratch_sample", {
	id: serial("id").primaryKey().notNull(),
...
export const zuvyOpenEndedQuestionsInMain = main.table("zuvy_openEnded_questions", {
	id: serial("id").primaryKey().notNull(),
...
(table) => {
	return {
		zuvyOpenEndedQuestionsTagIdZuvyTagsIdFk: foreignKey({
			columns: [table.tagId],
			foreignColumns: [zuvyTagsInMain.id],
			name: "zuvy_openEnded_questions_tag_id_zuvy_tags_id_fk"
		}),
	}
});

export const pathwaysInMain = main.table("pathways", {
	id: serial("id").primaryKey().notNull(),
	code: varchar("code", { length: 6 }).notNull(),
	name: varchar("name", { length: 45 }).notNull(),
	description: varchar("description", { length: 5000 }).notNull(),
...
export const zuvyRecentBootcampInMain = main.table("zuvy_recent_bootcamp", {
	id: serial("id").primaryKey().notNull(),
	userId: bigserial("user_id", { mode: "bigint" }).notNull(),
	bootcampId: integer("bootcamp_id").notNull(),
	moduleId: integer("module_id").notNull(),
...
export const gharUsersInMain = main.table("ghar_users", {
	id: serial("id").primaryKey().notNull(),
	email: varchar("email", { length: 255 }).notNull(),
});

export const zuvyQuestionTypeInMain = main.table("zuvy_question_type", {
	id: serial("id").primaryKey().notNull(),
