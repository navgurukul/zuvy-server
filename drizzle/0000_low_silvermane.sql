...
CREATE TABLE IF NOT EXISTS "main"."exercises" (
	...
	"slug" varchar(100) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE IF NOT EXISTS "main"."vb_sentences" (
	...
	"h_translation" varchar(255) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE IF NOT EXISTS "main"."vb_words" (
	...
	"e_meaning" varchar(250) DEFAULT ''::character varying NOT NULL,
	"h_meaning" varchar(250) DEFAULT ''::character varying NOT NULL,
	"word_type" varchar(5) DEFAULT ''::character varying,
	"d_level" bigint NOT NULL
);
--> statement-breakpoint
