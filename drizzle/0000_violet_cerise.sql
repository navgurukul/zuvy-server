...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "main"."sub_stage" ADD CONSTRAINT "main_sub_stage_stage_id_foreign" FOREIGN KEY ("stage_id") REFERENCES "main"."school_stage"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
