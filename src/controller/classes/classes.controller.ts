...
export class ClassesController {
  ...
  //   @Req() req,
  // ): Promise<object> {
  //   return this.classesService.calculateAttendance([{meetingId:'n86vec53pr5g1fk5kok2s36is4_20250508T053000Z'}],[
  //     { userId: 63145, email: "tanuja@navgurukul.org" },
  //     {userId:67396, email: 'khalilur@navgurukul.org'}
  //   ])
  // }
