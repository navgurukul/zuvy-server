...
export class UpdateZoomUserDto extends ZoomEmailDto {
  ...
  @ApiPropertyOptional({
    enum: [1, 2, 3],
    description: 'Optional license/type change while updating',
  })
  @IsOptional()
  @IsInt()
  @IsIn([1, 2, 3])
  ...
  @ApiPropertyOptional({
    example: true,
    description:
      'Reserve a dedicated Zoom seat for this user in the dynamic allocation pool',
  })
  @IsOptional()
  @Type(() => Boolean)
  @IsBoolean()
...
export class ZoomAuthorizedUsersQueryDto {
  @ApiPropertyOptional({
    enum: ['licensed', 'basic', 'all'],
    example: 'licensed',
    description: 'Filter users by current Zoom host type',
  })
  @IsOptional()
  @IsString()
  @IsIn(['licensed', 'basic', 'all'])
  hostType?: 'licensed' | 'basic' | 'all';

  @ApiPropertyOptional({
    example: 'active',
    description: 'Zoom user status filter',
  })
  @IsOptional()
  @IsString()
  status?: string;
  ...
  @ApiPropertyOptional({
    example: 100,
    description: 'Maximum page size to request from Zoom',
  })
  @IsOptional()
  @Type(() => Number)
  @IsInt()
...
class ZoomMeetingSettingsDto {
  ...
  @ApiPropertyOptional({ example: true })
  @IsOptional()
  attendance_reporting?: boolean;
  @ApiPropertyOptional({ example: true })
  @IsOptional()
  end_on_auto_off?: boolean;
  @ApiPropertyOptional({ example: true })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'instructor@example.com;cohost@example.com',
    description: 'Semicolon separated emails',
  })
  @IsOptional()
  @IsString()
  alternative_hosts?: string; // semicolon list
}

export class CreateZoomMeetingDto {
  @ApiProperty({ example: 'Weekly Live Class' }) @IsString() topic: string;
  @ApiPropertyOptional({ example: 'Overview of module 1' })
  @IsOptional()
  @IsString()
  agenda?: string;
  ...
  @ApiPropertyOptional({
    example: 2,
    description: 'Zoom meeting type (2=scheduled)',
  })
  @IsOptional()
...
export class UpdateZoomMeetingDto {
  @ApiPropertyOptional({ example: 'Updated Live Class Name' })
  @IsOptional()
  @IsString()
  topic?: string;
  @ApiPropertyOptional({ example: 'Updated agenda notes' })
  @IsOptional()
  @IsString()
  agenda?: string;
  @ApiPropertyOptional({ example: '2025-08-20T11:00:00Z' })
  @IsOptional()
  @IsISO8601()
  start_time?: string;
